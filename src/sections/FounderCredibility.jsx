...
export default function FounderCredibility() {
  return (
    <section className="py-24 md:py-32 border-b border-[var(--paper)]/15 bg-[var(--navy)]">
      <div className="container-x grid lg:grid-cols-[auto_1fr] gap-10 md:gap-16 items-center">
        <div className="shrink-0">
          <img
            ...
            className="w-32 h-32 md:w-40 md:h-40 rounded-2xl object-cover bg-[var(--navy)] border-2 border-[var(--lime)]"
          />
        </div>
        <div>
          <div className="eyebrow mb-4 text-[var(--paper)]/70">Meet the Founder</div>
          <h2 className="font-display font-semibold text-3xl md:text-5xl leading-[1.1] mb-4 text-[var(--paper)]">
            Steven Bennett<span className="text-[var(--paper)]/60 font-normal">, Founder & CEO, Trafy AI</span>
          </h2>
          ...
          <p className="text-[var(--paper)]/80 text-base md:text-lg leading-relaxed max-w-2xl mb-6">
          ...
          <p className="text-[var(--paper)] text-lg md:text-xl leading-relaxed max-w-2xl font-display">
