...
export default function AnnouncementAnniversary() {
  return (
    <section className="relative overflow-hidden mx-auto max-w-5xl px-4 sm:px-6 pt-24 sm:pt-32 pb-16 sm:pb-24 text-white">
      {/* Decorative Glow */}
      ...
      <div className="relative">
        ...
        <h1 className="mt-4 sm:mt-6 font-display text-3xl font-extrabold tracking-tight sm:text-5xl md:text-6xl leading-tight">
        ...
        <p className="mt-4 sm:mt-6 max-w-3xl text-base sm:text-xl leading-relaxed text-white/70">
      ...
      {/* Stats Grid */}
      <div className="mt-8 sm:mt-14 grid grid-cols-2 gap-3 sm:gap-4 sm:grid-cols-4">
        {stats.map((item) => (
          <div key={item.label} className="rounded-xl sm:rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-6 text-center">
            <div className="font-display text-2xl font-extrabold text-white sm:text-4xl">{item.value}</div>
            <div className="mt-1 sm:mt-2 text-[10px] sm:text-xs font-medium text-white/50">{item.label}</div>
          </div>
        ))}
      </div>

      {/* Celebration Note */}
      <div className="mt-10 sm:mt-16 rounded-2xl sm:rounded-3xl border border-white/15 bg-gradient-to-br from-white/[0.07] to-white/[0.02] p-5 sm:p-12 relative overflow-hidden">
        ...
        <div className="mt-4 sm:mt-6 space-y-3 sm:space-y-4 text-sm sm:text-base leading-relaxed text-white/75">
          <p>
        ...
        <div className="mt-6 sm:mt-8 flex items-center gap-3 sm:gap-4 pt-4 sm:pt-6 border-t border-white/10">
          <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-full bg-green-hard font-display text-base sm:text-lg font-bold text-ink">
            T
          </div>
          <div>
      ...
      <div className="mt-12 sm:mt-20">
        ...
        <div className="mt-5 sm:mt-8 grid gap-4 sm:gap-6 sm:grid-cols-2">
          {milestones.map((m) => (
            <div
              key={m.year}
              className="rounded-xl sm:rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-6 transition-all duration-300 hover:border-white/20"
            >
      ...
      <div className="mt-10 sm:mt-16 rounded-xl sm:rounded-2xl border border-green-hard/20 bg-green-hard/5 p-5 sm:p-8 text-center sm:text-left sm:flex sm:items-center sm:justify-between sm:gap-8">
        <div>
